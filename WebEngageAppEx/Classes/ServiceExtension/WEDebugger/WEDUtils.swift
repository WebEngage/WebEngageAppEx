...
struct WEDUtils{
    ...
    static func getDataFromSharedUserDefaults() -> [String: Any]? {
        ...
        var data = [String: Any]()
        data[WEDConstants.WEX_LICENSE_CODE] = defaults.string(forKey: WEDConstants.WEX_LICENSE_CODE)
        data[WEDConstants.WEX_INTERFACE_ID] = defaults.string(forKey: WEDConstants.WEX_INTERFACE_ID)
        data[WEDConstants.KEY_DEBUGGER_EVENT_SYNC_URL] = defaults.string(forKey: WEDConstants.KEY_DEBUGGER_EVENT_SYNC_URL)
        
        if let sdkVersion = defaults.string(forKey: WEDConstants.WEX_SDK_VERSION), let intValue = Int(sdkVersion) {
            data[WEDConstants.WEX_SDK_VERSION] = String(intValue)
        }
        data[WEDConstants.WEX_APP_ID] = defaults.string(forKey: WEDConstants.WEX_APP_ID)
        return data
    }
}
